...
local L = LibStub("AceLocale-3.0"):GetLocale("DefaultUI_Colours")
local GetWoWVersion = ((select(4, GetBuildInfo())))
--local texturepackCheck    = "1.0.1.7"
--local texturepackDate     = "26/11/20"
local f = CreateFrame("Frame", "DefaultUI_Colours_Config", UIParent)
f:SetSize(50, 50)
f:RegisterEvent("PLAYER_LOGIN")
f:SetScript("OnEvent", function(self, event, ...)
  character = UnitName("player").."-"..GetRealmName()
  -- Config/Panel
  if not DefaultUI_Colours_Config then
    local DefaultUI_Colours_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_Colours\\textures\\extra\\dialogFrameTexture"
...
local function InitSettings()
  DefaultUI_Colours_Config.panel = CreateFrame("Frame", "$parentDefaultUI_Colours_Config", InterfaceOptionsFramePanelContainer)
...
BasicFrames:SetScript("OnEvent", function(self, event, addon)
	if (addon == "DefaultUI_Colours") then
		for i, v in pairs({	
			PlayerFrameTexture,
...
-- Frame Colorization --
  ...
  local AbyssUIVertexColorFrames01_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames01_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames02_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames02_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames03_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames03_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames04_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames04_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames05_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames05_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames06_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames06_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames07_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames07_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames08_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames08_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames09_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames09_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames10_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames10_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames11_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames11_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames12_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames12_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames13_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames13_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames14_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames14_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames15_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames15_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames16_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames16_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  local AbyssUIVertexColorFrames17_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFrames17_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
  ...
  f:RegisterEvent("PLAYER_ENTERING_WORLD")
  f:SetScript("OnEvent", function() 
    local AbyssUIVertexColorFramesColorPicker_Button = CreateFrame("Button", "$parentAbyssUIVertexColorFramesColorPicker_Button", DefaultUI_Colours_Config.panel, "UIPanelButtonTemplate")
  ...
  -- Apply Color
  local AbyssUIVertexColorFramesColorPicker_CheckButton = CreateFrame("CheckButton", "$parentAbyssUIVertexColorFramesColorPicker_CheckButton", DefaultUI_Colours_Config.panel, "ChatConfigCheckButtonTemplate")
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_Colours") then
